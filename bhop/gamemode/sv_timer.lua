...
-- Edited: justa
-- I'm aware doing what I did here isn't very efficient seeing as shit like this is networked already...
-- Buttttt... idk whether all this stuff will be recoded so I did it anyway, feel free to change as long as scoreboard still works.
